...
class Nodo:
    ...
    def insert_initial_sucursales(self):
        sucursales_data = [
            (1, '192.168.222.128', 0, 0, 1, 5, 0, 5),
            (2, '192.168.222.129', 0, 0, 1, 5, 0, 5),
            (3, '192.168.222.130', 0, 0, 1, 10, 0, 10),
            (4, '192.168.222.131', 1, 0, 1, 10, 0, 10),
            (5, '192.168.222.132', 0, 1, 1, 15, 0, 15)
        ]
    ...
    def main_menu(self):
        ...
        server_thread = threading.Thread(target=start_server, args=(self.get_current_sucursal_ip(), 2222))
        server_thread.start()
