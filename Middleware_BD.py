...
class Nodo:
    ...
    def insert_initial_sucursales(self):
        sucursales_data = [
            (1, '192.168.222.128', 0, 0, 1, 10, 0, 10),
            (2, '192.168.222.129', 0, 0, 1, 10, 0, 10),
            (3, '192.168.222.130', 0, 1, 1, 10, 0, 10),
            (4, '192.168.222.131', 0, 0, 1, 10, 0, 10),
            (5, '192.168.222.132', 1, 0, 1, 10, 0, 10)
        ]
